...
<div class="form-group">
  ...
  <input type="text" name="address1" class="form-control" id="inputAddress" placeholder="No ,  Street name" required>
</div>
<div class="form-group">
  <label for="inputAddress2">Address 2</label>
  <input type="text" name="address2" class="form-control" id="inputAddress2" placeholder="Enter permanant adderess">
</div>
...
<button type="submit" class="btn btn-primary button " style= "text-align:center; padding-left:500px; padding-right:500px;">Submit</button>
</form>`;
